...
cfg.mean = [0.5, 0.5, 0.5] # insightface default
cfg.std = [0.5, 0.5, 0.5] # insightface default
...
decoder = torch.load('./weights/_tmp_buffalo_decoder_on_fr_wo_discr_wo_pixel_loss_last.pth', map_location='cpu')
decoder.to(device)
decoder.eval()
...
test_templates_paths = [f"{local_data_path}/templatesgen_glint_0_10K.pkl"]
